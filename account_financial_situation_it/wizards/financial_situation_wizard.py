...
class FinancialSituationWizard(models.TransientModel):
	...
	def get_pdf_financial_situation(self):
		...
		return self.env['popup.it'].get_file('Situacion Financiera.pdf',base64.encodestring(b''.join(f.readlines())))
	...
	def get_excel_financial_situation(self):
		...
		return self.env['popup.it'].get_file('Situacion Financiera.xlsx',base64.encodestring(b''.join(f.readlines())))