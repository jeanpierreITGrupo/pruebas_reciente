...
class AccountSunatWizard(models.TransientModel):
	...
	def get_excel_diario(self):
		...
		workbook = ReportBase.get_excel_sql_export(sql_ple,['CAMPO 1','CAMPO 2','CAMPO 3','CAMPO 4','CAMPO 5','CAMPO 6','CAMPO 7','CAMPO 8','CAMPO 9',
		'CAMPO 10','CAMPO 11','CAMPO 12','CAMPO 13','CAMPO 14','CAMPO 15','CAMPO 16','CAMPO 17','CAMPO 18','CAMPO 19','CAMPO 20','CAMPO 21'])
	...
	def get_pdf_libro_diario(self):
		...
		return self.env['popup.it'].get_file('LIBRO DIARIO '+ self.period_id.name,base64.encodestring(b''.join(f.readlines())))
	...
	def get_pdf_libro_mayor(self):
		...
		f = open(str(direccion) + name_file, 'rb')		
		return self.env['popup.it'].get_file('LIBRO MAYOR '+ self.period_id.name,base64.encodestring(b''.join(f.readlines())))
	...
	def get_pdf_compras(self):
		...
		f = open(str(direccion) + name_file, 'rb')		
		return self.env['popup.it'].get_file('REGISTRO DE COMPRAS '+ self.period_id.name,base64.encodestring(b''.join(f.readlines())))
	...
	def get_pdf_ventas(self):
		...
		f = open(str(direccion) + name_file, 'rb')		
		return self.env['popup.it'].get_file('REGISTRO DE VENTAS  '+ self.period_id.name,base64.encodestring(b''.join(f.readlines())))
	...
	def get_pdf_libro_caja(self):
		...
		f = open(str(direccion) + name_file, 'rb')		
		return self.env['popup.it'].get_file('LIBRO CAJA '+ self.period_id.name,base64.encodestring(b''.join(f.readlines())))
	...
	def get_pdf_libro_banco(self):
		...
		f = open(str(direccion) + name_file, 'rb')		
		return self.env['popup.it'].get_file('LIBRO BANCOS '+ self.period_id.name,base64.encodestring(b''.join(f.readlines())))
	...
	def get_pdf_inventario_balance(self):
		...
		sql = self.env['account.base.sunat'].pdf_get_sql_vst_inventario(self.period_id.date_start,self.period_id.date_end,self.company_id.id)
		self.env.cr.execute(sql)
		res = self.env.cr.dictfetchall()
		...
		f = open(str(direccion) + name_file, 'rb')		
		return self.env['popup.it'].get_file('LIBRO INVENTARIO Y BALANCE '+ self.period_id.name,base64.encodestring(b''.join(f.readlines())))
	...
	def get_pdf_10_caja_bancos(self):
		...
		f = open(str(direccion) + name_file, 'rb')		
		return self.env['popup.it'].get_file('LIBRO DE INVENTARIO Y BALANCE - DETALLE CUENTA 10  '+ self.period_id.name,base64.encodestring(b''.join(f.readlines())))
	...
	def get_pdf_12_cliente(self):
		...
		sql = self.env['account.base.sunat'].pdf_get_sql_vst_12_cliente(self.period_id.date_start,self.period_id.date_end,self.company_id.id)
		self.env.cr.execute(sql)
		res = self.env.cr.dictfetchall()
		...
		f = open(str(direccion) + name_file, 'rb')		
		return self.env['popup.it'].get_file('LIBRO DE INVENTARIO Y BALANCE - DETALLE CUENTA 12 '+ self.period_id.name,base64.encodestring(b''.join(f.readlines())))
	...
	def get_pdf_13_cobrar_relacionadas(self):
		...
		sql = self.env['account.base.sunat'].pdf_get_sql_vst_13_cobrar_relacionadas(self.period_id.date_start,self.period_id.date_end,self.company_id.id)
		self.env.cr.execute(sql)
		res = self.env.cr.dictfetchall()
		...
		f = open(str(direccion) + name_file, 'rb')		
		return self.env['popup.it'].get_file('LIBRO DE INVENTARIO Y BALANCE - DETALLE CUENTA 13 '+ self.period_id.name,base64.encodestring(b''.join(f.readlines())))
	...
	def get_pdf_14_cobrar_acc_personal(self):
		...
		sql = self.env['account.base.sunat'].pdf_get_sql_vst_14_cobrar_acc_personal(self.period_id.date_start,self.period_id.date_end,self.company_id.id)
		self.env.cr.execute(sql)
		res = self.env.cr.dictfetchall()
		...
		f = open(str(direccion) + name_file, 'rb')		
		return self.env['popup.it'].get_file('LIBRO DE INVENTARIO Y BALANCE - DETALLE CUENTA 14 '+ self.period_id.name,base64.encodestring(b''.join(f.readlines())))
	...
	def get_pdf_16_cobrar_diversas(self):
		...
		sql = self.env['account.base.sunat'].pdf_get_sql_vst_16_cobrar_diversas(self.period_id.date_start,self.period_id.date_end,self.company_id.id)
		self.env.cr.execute(sql)
		res = self.env.cr.dictfetchall()
		...
		f = open(str(direccion) + name_file, 'rb')		
		return self.env['popup.it'].get_file('LIBRO DE INVENTARIO Y BALANCE - DETALLE CUENTA 16 '+ self.period_id.name,base64.encodestring(b''.join(f.readlines())))
	...
	def get_pdf_19_cobrar_dudosa(self):
		...
		sql = self.env['account.base.sunat'].pdf_get_sql_vst_19_cobrar_dudosa(self.period_id.date_start,self.period_id.date_end,self.company_id.id)
		self.env.cr.execute(sql)
		res = self.env.cr.dictfetchall()
		...
		f = open(str(direccion) + name_file, 'rb')		
		return self.env['popup.it'].get_file('LIBRO DE INVENTARIO Y BALANCE - DETALLE CUENTA 19 '+ self.period_id.name,base64.encodestring(b''.join(f.readlines())))
	...
	def get_pdf_cuenta_40(self):
		...
		f = open(str(direccion) + name_file, 'rb')		
		return self.env['popup.it'].get_file('LIBRO DE INVENTARIO Y BALANCE - DETALLE CUENTA 40 '+ self.period_id.name,base64.encodestring(b''.join(f.readlines())))
	...
	def get_pdf_cuenta_41(self):
		...
		sql = self.env['account.base.sunat'].pdf_get_sql_vst_41(self.period_id.date_start,self.period_id.date_end,self.company_id.id)
		self.env.cr.execute(sql)
		res = self.env.cr.dictfetchall()
		...
		f = open(str(direccion) + name_file, 'rb')		
		return self.env['popup.it'].get_file('LIBRO DE INVENTARIO Y BALANCE - DETALLE CUENTA 41 '+ self.period_id.name,base64.encodestring(b''.join(f.readlines())))
	...
	def get_pdf_cuenta_42(self):
		...
		sql = self.env['account.base.sunat'].pdf_get_sql_vst_42(self.period_id.date_start,self.period_id.date_end,self.company_id.id)
		self.env.cr.execute(sql)
		res = self.env.cr.dictfetchall()
		...
		f = open(str(direccion) + name_file, 'rb')		
		return self.env['popup.it'].get_file('LIBRO DE INVENTARIO Y BALANCE - DETALLE CUENTA 42 '+ self.period_id.name,base64.encodestring(b''.join(f.readlines())))
	...
	def get_pdf_cuenta_43(self):
		...
		sql = self.env['account.base.sunat'].pdf_get_sql_vst_43(self.period_id.date_start,self.period_id.date_end,self.company_id.id)
		self.env.cr.execute(sql)
		res = self.env.cr.dictfetchall()
		...
		f = open(str(direccion) + name_file, 'rb')		
		return self.env['popup.it'].get_file('LIBRO DE INVENTARIO Y BALANCE - DETALLE CUENTA 43 '+ self.period_id.name,base64.encodestring(b''.join(f.readlines())))
	...
	def get_pdf_cuenta_44(self):
		...
		sql = self.env['account.base.sunat'].pdf_get_sql_vst_44(self.period_id.date_start,self.period_id.date_end,self.company_id.id)
		self.env.cr.execute(sql)
		res = self.env.cr.dictfetchall()
		...
		f = open(str(direccion) + name_file, 'rb')		
		return self.env['popup.it'].get_file('LIBRO DE INVENTARIO Y BALANCE - DETALLE CUENTA 44 '+ self.period_id.name,base64.encodestring(b''.join(f.readlines())))
	...
	def get_pdf_cuenta_45(self):
		...
		sql = self.env['account.base.sunat'].pdf_get_sql_vst_45(self.period_id.date_start,self.period_id.date_end,self.company_id.id)
		self.env.cr.execute(sql)
		res = self.env.cr.dictfetchall()
		...
		f = open(str(direccion) + name_file, 'rb')		
		return self.env['popup.it'].get_file('LIBRO DE INVENTARIO Y BALANCE - DETALLE CUENTA 45 '+ self.period_id.name,base64.encodestring(b''.join(f.readlines())))
	...
	def get_pdf_cuenta_46(self):
		...
		sql = self.env['account.base.sunat'].pdf_get_sql_vst_46(self.period_id.date_start,self.period_id.date_end,self.company_id.id)
		self.env.cr.execute(sql)
		res = self.env.cr.dictfetchall()
		...
		f = open(str(direccion) + name_file, 'rb')		
		return self.env['popup.it'].get_file('LIBRO DE INVENTARIO Y BALANCE - DETALLE CUENTA 46 '+ self.period_id.name,base64.encodestring(b''.join(f.readlines())))
	...
	def get_pdf_cuenta_47(self):
		...
		sql = self.env['account.base.sunat'].pdf_get_sql_vst_47(self.period_id.date_start,self.period_id.date_end,self.company_id.id)
		self.env.cr.execute(sql)
		res = self.env.cr.dictfetchall()
		...
		f = open(str(direccion) + name_file, 'rb')		
		return self.env['popup.it'].get_file('LIBRO DE INVENTARIO Y BALANCE - DETALLE CUENTA 47 '+ self.period_id.name,base64.encodestring(b''.join(f.readlines())))
	...
	def get_pdf_cuenta_48(self):
		...
		sql = self.env['account.base.sunat'].pdf_get_sql_vst_48(self.period_id.date_start,self.period_id.date_end,self.company_id.id)
		self.env.cr.execute(sql)
		res = self.env.cr.dictfetchall()
		...
		f = open(str(direccion) + name_file, 'rb')		
		return self.env['popup.it'].get_file('LIBRO DE INVENTARIO Y BALANCE - DETALLE CUENTA 48 '+ self.period_id.name,base64.encodestring(b''.join(f.readlines())))
	...
	def get_pdf_cuenta_49(self):
		...
		sql = self.env['account.base.sunat'].pdf_get_sql_vst_49(self.period_id.date_start,self.period_id.date_end,self.company_id.id)
		self.env.cr.execute(sql)
		res = self.env.cr.dictfetchall()
		cont = 0
		doc_partner = ''
		...
		f = open(str(direccion) + name_file, 'rb')		
		return self.env['popup.it'].get_file('LIBRO DE INVENTARIO Y BALANCE - DETALLE CUENTA 49 '+ self.period_id.name,base64.encodestring(b''.join(f.readlines())))