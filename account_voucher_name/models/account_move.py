...
class AccountMove(models.Model):
	...
	def _check_unique_sequence_name(self):
		moves = self.filtered(lambda move: move.state == 'posted')
		if not moves:
			return

		self.flush(['name', 'journal_id', 'state'])
		...
		if res:
			raise UserError(u'El asiento contable validado debe tener un número de secuencia único por compañía.')