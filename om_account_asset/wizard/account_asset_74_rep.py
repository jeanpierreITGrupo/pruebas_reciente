...
class AccountAsset74Rep(models.TransientModel):
	...
	def get_excel(self):
		...
		return self.env['popup.it'].get_file('Activos en Leasing Formato 74.xlsx',base64.encodestring(b''.join(f.readlines())))
	...
	#Crear Tabla
		...
		return self.env['popup.it'].get_file('Activos en Leasing Formato 74.pdf',base64.encodestring(b''.join(f.readlines())))
