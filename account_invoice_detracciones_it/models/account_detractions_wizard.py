	...
	def generar(self):
		...
		if invoice.move_type == 'in_invoice':
			...
			line_cc = (0,0,{
				...
				'debit': round(self.monto * invoice.currency_rate) if invoice.currency_id != invoice.company_id.currency_id else self.monto,
				'credit':0,
			...
			line_cc = (0,0,{
				...
				'debit': 0,
				'credit':round(self.monto * invoice.currency_rate) if invoice.currency_id != invoice.company_id.currency_id else self.monto,
				'name':'DETRACCION - '+invoice.ref,
				'partner_id': invoice.partner_id.id,
				'nro_comp': invoice.ref,
